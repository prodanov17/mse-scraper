...
def fetch_news_links(issuer):
    """
    Method to fetch the news links for a specific issuer.
    :param issuer: The issuer code (e.g. KMB, ADIN...)
    :return:
    """
...
def extract_news_id(url):
    """
    Method to extract the news id for a specific url.
    :param url: The url to extract the news id from
    :return:
    """
    return url.split("/")[-1]
...
def extract_date(date_str):
    """
    Method to extract the date for a specific date.
    :param date_str: The date string to extract the date from
    :return: the date extracted from the date string | None
    """
    try:
...
def fetch_news_content(news_id):
    """
        Fetch the detailed content of a news article
        :param news_id: The unique identifier of the news article
...
def analyze(news_contents):
    """
    Analyze the content of a news article by using the NLP service
    :param news_contents: list of news
...
def get_news_sentiment(issuer):
    """
    Endpoint to analyze the sentiment of a news article by using the NLP service
    :param issuer: the company key (e.g. KMB, ADIN...)
    :return: json
    """
