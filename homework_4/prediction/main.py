...
def predict_next_day(symbol):
    """
    Function to predict the price for the next day based on the last data
    :param symbol: company key
    :return: the price
    """
...
def predict():
    """
    The endpoint for predicting the price for the next day based on the last data
    :return: json
    """
